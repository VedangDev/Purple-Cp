...
// Load packages.
console.log(chalk.green(`[Purple CP] Loading FS...`))
const fs = require("fs");
console.log(chalk.green(`[Purple CP] Loaded FS...`))
console.log(chalk.green(`[Purple CP] Loading Node-Fetch...`))
const fetch = require('node-fetch');
console.log(chalk.green(`[Purple CP] Loaded Node-Fetch...`))
const chalk = require("chalk");
const arciotext = (require("./api/arcio.js")).text;

// Load settings.
console.log(chalk.green(`[Purple CP] Loading Settings...`))
const settings = require("./settings.json");
console.log(chalk.green(`[Purple CP] Loaded Settings...`))
...
const listener = app.listen(settings.website.port, function() {
  console.log(chalk.green("[Purple CP] Checking for updates..."));
  // no update system yet, soontm
  console.log(chalk.purple("[Purple CP] Finishing & deploying Purple CP..."));
  console.log(chalk.purple("----------------------------------------------------"));
  console.log(chalk.purple("Purple CP: v1"));
  console.log(chalk.purple("Release: v1.4.1"));
  console.log(chalk.purple("----------------------------------------------------"));
  console.log(chalk.purple("Your dashboard will now be available on port " + listener.address().port + " "));
  console.log(chalk.purple("----------------------------------------------------"));
});
